...
// Top destinations for Bali fastboat tourists — pinned at top of dropdown
...
// All other countries (ISO 3166-1) — alphabetical, full world coverage
...
// Top countries first, then all others alphabetical
export const COUNTRIES: Country[] = [...TOP_COUNTRIES, ...OTHER_COUNTRIES];

// Codes of top countries — used by picker to show "Popular" divider
